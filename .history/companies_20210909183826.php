...
<body>
    <div class="container">
        ...
        <div class="companyForm">
            <input  id="pavadinimas" class="form-control" placeholder="Įveskita vardą" />
            <input id="aprasymas" class="form-control" placeholder="Įveskita pavardę" />
            <input id="tipas_id" class="form-control" placeholder="Įveskita teisės id" />
