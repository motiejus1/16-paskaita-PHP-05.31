...
<body>
    ...
    <div class="container">
        ...
        <button id="create"> Create New Clinet </button>
        <div id="clientForm" class="d-none">
            <input id="vardas" placeholder="Įveskita vardą" />
            <input id="pavarde" placeholder="Įveskita pavardę" />
            <input id="teises_id" placeholder="Įveskita teisės id" />
        </div>
